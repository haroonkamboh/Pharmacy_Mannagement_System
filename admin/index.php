...
<body>
    ...
    <!--------------------------------- Sideber -------------------------------->
    <section id="sideber" class="sideber" style:green;>
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left"></i>Online Pharmacy Management System</h3>
            ...
            <?php if ( 'admin' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addManager' == $id ) {
                    ...
                    <a href="index.php?id=addManager"><i id="left" class="fas fa-user-plus"></i></i>Add Admin</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allManager' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allManager"><i id="left" class="fas fa-user"></i>All Admin</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole ) {?>
                <!-- For Admin, Manager -->
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addItems' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="index.php?id=addItems"><i id="left" class="fas fa-user-plus"></i></i>Add Item</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allItems' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allItems"><i id="left" class="fas fa-user"></i>All Items</a>
            </li>
    ...
    echo " active";
             ...
             <li id="left" class="sideber__item<?php if ( 'orders' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=orders"><i id="left" class="fas fa-user"></i>Orders</a>
            </li>
        </ul>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
                                    ...
                                    <h1>
                                        <?php
                                            $query = "SELECT COUNT(*) id FROM items;";
                                                $result = mysqli_query( $connection, $query );
                                                $totalitems = mysqli_fetch_assoc( $result );
                                                echo $totalitems['id'];
                                            ?>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $getItem = "SELECT * FROM items";
                                            $result = mysqli_query( $connection, $getItem );

                                        while ( $item = mysqli_fetch_assoc( $result )) {?>

                                        <tr>
                                            <td><?php printf( "%s", $item['Name']);?></td>
                                            <td><?php printf( "%s", $item['Price'] );?></td>
                                            <td><?php printf( "%s", $item['Quantity'] );?></td>
                                            <td><?php printf( "%s", $item['Description'] );?></td>
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole ) {?>
                                                <!-- For Admin, Manager -->
                                                <td><?php printf( "<a href='index.php?action=editItem&id=%s'><i class='fas fa-edit'></i></a>", $item['Id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deleteItem&id=%s'><i class='fas fa-trash'></i></a>", $item['Id'] )?></td>
                                            <?php }?>
                                        </tr>
                        ...
                        <div class="main__form">
                            ...
                            <form action="add.php" method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-flask"></i>
                                            <input type="text" name="name" placeholder="Product Name" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-money-bill-alt"></i>
                                            <input type="text" name="price" placeholder="Price" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-archive"></i>
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-flask"></i>
                                            <input type="text" name="name" placeholder="Name" value="<?php echo $item['Name']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-money-bill-alt"></i>
                                            <input type="text" name="price" placeholder="Price" value="<?php echo $item['Price']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                    ...
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-phone-alt"></i>
                                            <input type="text" name="description" placeholder="Description" value="<?php echo $item['Description']; ?>" required>
                                        </label>
                                    </div>
